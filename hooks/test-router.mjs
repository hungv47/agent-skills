...
const tests = [
  ["I need to write some social media content for LinkedIn", "content-create"],
  ["Who is our target audience?", "icp-research"],
  ["Do a competitive analysis of the CRM market", "market-research"],
  ["Why is our signup rate dropping?", "problem-analysis"],
  ["What should we build next? Prioritize the options", "solution-design"],
  ["Model the funnel from traffic to revenue", "funnel-planner"],
  ["Design an A/B test for the new pricing page", "experiment"],
  ["What content are our competitors posting?", "content-research"],
  ["Build our brand identity and voice guidelines", "brand-system"],
  ["Write copy for the hero section headline", "copywriting"],
  ["Create a newsletter for our product launch", "content-create"],
  ...
  ["Write documentation for the API", "technical-writer"],
  ["Ship it, create a PR", "ship"],
  ["Is production healthy after the deploy?", "deploy-verify"],
  ["I have an idea, help me scope this", "discover"],
  ["Debate this from multiple perspectives", "agent-room"],
  ["Break this down into tasks with acceptance criteria", "task-breakdown"],
  ["Review my code", "review-chain"],
  ["Which skill should I use for this?", "navigate"],
];
